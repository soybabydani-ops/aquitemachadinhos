...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const priorityUrls = [
      ...
      `https://${HOST}/utilidade-publica/sao-paulo/doacoes-e-desapegos.html`,
      `https://${HOST}/alerta-transito/rodovia-presidente-dutra-travada.html`,
      `https://${HOST}/alerta-transito/rodovia-dos-imigrantes-acidente-serra.html`,
      `https://${HOST}/concursos/barretos-inscricoes-abertas.html`,
      `https://${HOST}/concursos/sao-paulo-inscricoes-abertas.html`,
      `https://${HOST}/alerta-clima/barretos-alerta-meteorologico.html`,
      `https://${HOST}/alerta-clima/sao-paulo-alerta-meteorologico.html`,
