/**
 * GERADOR DE PÁGINAS PROGRAMÁTICAS DE VIAGENS E VAGAS - REGIÃO METROPOLITANA DE SP
 * Rotas de alto tráfego com Social Locker e Monetização Dupla.
 */

const fs = require('fs');
const path = require('path');

const METRO_SP_ROUTES = [
  {
    origem: 'Guarulhos',
    ...
    desconto: '-77%',
    minutosTimer: 18,
    vagasLocais: ['Motorista CNH B (Diurno/Noturno) - R$ 3.800', 'Atendente Bilheteria Aeroporto - R$ 2.450', 'Auxiliar de Logística GRU - R$ 2.100'],
    pousadaComercio: 'Hotel & Suítes Executivas Paulista (Desconto exclusivo no WhatsApp)',
    linkAfiliado: 'https://wa.me/5511991238899?text=Ol%C3%A1!%20Desbloqueei%20o%20bug%20de%20tarifa%20Guarulhos-SP%20no%20Aqui%20Tem%20e%20quero%20minha%20passagem.'
  },
  {
    origem: 'Campinas',
    origemSlug: 'campinas',
    ...
    desconto: '-65%',
    minutosTimer: 24,
    vagasLocais: ['Analista de Sistemas Jr (Home/Híbrido) - R$ 5.200', 'Motorista de Van Executiva - R$ 3.900', 'Vendedor Corporativo - R$ 3.100'],
    pousadaComercio: 'Flat & Coworking Faria Lima Prime',
    linkAfiliado: 'https://wa.me/5511997814500?text=Ol%C3%A1!%20Quero%20a%20tarifa%20relampago%20Campinas-SP%20por%20R$%2019,90.'
  },
  {
    origem: 'São Paulo Capital',
    origemSlug: 'sao-paulo',
    origemBairros: 'Terminal Jabaquara & Metrô Santos-Imigrantes',
    ...
    desconto: '-70%',
    minutosTimer: 15,
    vagasLocais: ['Operador Portuário Santos - R$ 4.500', 'Recepcionista Hotel Gonzaga - R$ 2.200', 'Atendente Quiosque Praia - R$ 1.950'],
    pousadaComercio: 'Pousada & Suítes Gonzaga Beach 24h',
    linkAfiliado: 'https://wa.me/5511996552211?text=Ol%C3%A1!%20Quero%20a%20passagem%20SP-Santos%20por%20R$%2012,90.'
  },
  {
    origem: 'São Bernardo do Campo',
    origemSlug: 'sao-bernardo-do-campo',
    origemBairros: 'Rudge Ramos / Centro / Paço',
    destino: 'São Paulo Capital',
    destinoSlug: 'sao-paulo',
    destinoPonto: 'Metrô Sacomã & Av. Paulista',
    tipo: 'Van Executiva & Carona Compartilhada',
    precoNormal: 'R$ 35,00',
    precoBug: 'R$ 8,90',
    desconto: '-74%',
    minutosTimer: 21,
    vagasLocais: ['Auxiliar de Montagem Industrial - R$ 2.800', 'Motorista Particular ABC - R$ 3.600', 'Atendente Farmácia 24h - R$ 2.150'],
    pousadaComercio: 'Restaurante & Trattoria Rudge Ramos',
    linkAfiliado: 'https://wa.me/5511991238899?text=Ol%C3%A1!%20Quero%20o%20transfer%20SBC-SP%20por%20R$%208,90.'
  },
  {
    origem: 'Osasco',
    origemSlug: 'osasco',
    origemBairros: 'Estação Osasco / Bela Vista',
    destino: 'São Paulo Capital',
    destinoSlug: 'sao-paulo',
    destinoPonto: 'Pinheiros & Av. Faria Lima',
    tipo: 'Transfer VIP & Van Expressa',
    precoNormal: 'R$ 28,00',
    precoBug: 'R$ 7,50',
    desconto: '-73%',
    minutosTimer: 12,
    vagasLocais: ['Analista de Suporte TI - R$ 4.100', 'Atendente E-commerce Osasco - R$ 2.300', 'Motorista de Aplicativo - R$ 4.000'],
    pousadaComercio: 'Hotel Executivo Osasco Prime',
    linkAfiliado: 'https://wa.me/5511988887777?text=Ol%C3%A1!%20Quero%20a%20tarifa%20Osasco-SP%20por%20R$%207,50.'
  },
  {
    origem: 'Mogi das Cruzes',
    origemSlug: 'mogi-das-cruzes',
    origemBairros: 'Centro / Mogi Shopping / Braz Cubas',
    destino: 'São Paulo Capital',
    destinoSlug: 'sao-paulo',
    destinoPonto: 'Metrô Tatuapé & Terminal Brás',
    tipo: 'Ônibus Executivo & Van',
    precoNormal: 'R$ 42,00',
    precoBug: 'R$ 11,90',
    desconto: '-71%',
    minutosTimer: 27,
    vagasLocais: ['Assistente Administrativo Mogi - R$ 2.600', 'Vendedor de Loja Shopping - R$ 2.100', 'Motorista de Carga Leve - R$ 3.300'],
    pousadaComercio: 'Pousada & Chalés da Serra de Mogi',
    linkAfiliado: 'https://wa.me/5511977776666?text=Ol%C3%A1!%20Quero%20a%20passagem%20Mogi-SP%20por%20R$%2011,90.'
  },
  {
    origem: 'São Paulo Capital',
    origemSlug: 'sao-paulo',
    ...
    desconto: '-82%',
    minutosTimer: 31,
    vagasLocais: ['Barman / Bartender Temporário Arena - R$ 350/dia', 'Segurança de Eventos Credenciado - R$ 300/dia', 'Recepcionista de Pousada Rural - R$ 2.800/mês'],
    pousadaComercio: 'Pousada Recanto dos Peões & Chalés (WhatsApp Direto)',
    linkAfiliado: 'https://wa.me/5517991238899?text=Ol%C3%A1!%20Quero%20minha%20passagem%20SP-Barretos%20por%20R$%2049,90%20no%20Aqui%20Tem.'
  }
];

function gerarHTMLPagina(r) {
...
<meta name="description" content="[ALERTA DE SISTEMA] Quebra de algoritmo de tarifa residual de ${r.origem} para ${r.destino}. De ${r.precoNormal} por ${r.precoBug} (${r.desconto}). Reserve antes da correção.">
...
<style>
  ...
  .gold-border { border: 2px solid #F5D77F; box-shadow: 0 0 25px rgba(245,215,127,0.2); }
</style>
</head>
<body class="min-h-screen flex flex-col p-4 sm:p-6">
<div class="max-w-2xl mx-auto w-full">

  <!-- STATUS DO SCANNER HACKER -->
  ...
  <!-- CONTEÚDO DO HACK: EXPLICAÇÃO DO ALGORITMO -->
  <div class="bg-slate-900/90 border border-white/10 rounded-2xl p-5 mb-6 text-sm text-slate-300 space-y-3">
    ...
    <div class="p-3.5 rounded-xl bg-amber-400/10 border border-amber-400/25 text-xs text-amber-300 leading-relaxed">
  ...
  <!-- SOCIAL LOCKER (MOTOR DE TRÁFEGO VIRAL 24H) -->
  ...
  <!-- BLOCO SUPERIOR DE MONETIZAÇÃO (LINK DIRETO DESBLOQUEADO) -->
  ...
  <!-- BLOCO INFERIOR DE MONETIZAÇÃO (GANHO LOCAL: VAGAS & COMÉRCIO DA CIDADE) -->
  <div class="bg-slate-900/90 border border-amber-400/30 rounded-2xl p-5 mb-8">
    ...
    <p class="text-xs text-slate-400 mb-3">Vagas de emprego recentes abertas na região de ${r.destino}:</p>
...
METRO_SP_ROUTES.forEach(route => {
  const fileName = `${route.origemSlug}-para-${route.destinoSlug}.html`;
  const fullPath = path.join(__dirname, '..', 'vagas-e-viagens', fileName);
  fs.writeFileSync(fullPath, gerarHTMLPagina(route), 'utf8');
  console.log(`✓ Gerada página programática RMSP: vagas-e-viagens/${fileName}`);
});
