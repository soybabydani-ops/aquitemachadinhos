...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    injectLayout(); renderSocialProof(); initCountdown(); registerSW(); initAnalytics(); wireMP();
